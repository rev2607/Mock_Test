...
const Hero = () => {
  ...
  return (
    <section className="relative hero_banner from-[var(--site-green)] to-[var(--site-green)] pt-24 pb-24 md:pb-40 min-h-[600px]">
              ...
              return (
                <div className="" key={item.label}>
                  <a
                    ...
                    className="flex flex-col items-center p-4 rounded border-1 border-[#C4C4C4] hover:bg-opacity-30 transition-all duration-300 text-[var(--site-green)]"
                  >
                    <IconComponent className="h-8 w-8  mb-2 text-[var(--site-green)]" />
