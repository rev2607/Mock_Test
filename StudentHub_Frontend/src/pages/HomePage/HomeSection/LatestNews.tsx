...
const ArrowRight = () => (
  <svg className="ml-2" width="20" height="20" fill="none" viewBox="0 0 24 24"><path d="M10 8l4 4-4 4" stroke="#fff" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/></svg>
);
    ...
    <section className="bg-white px-6 py-16">
      <div className="container mx-auto px-4">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between mb-8">
          <h1 className="text-3xl font-bold text-gray-800 mb-2 sm:mb-0 whitespace-nowrap">Latest News &amp; Stories</h1>
